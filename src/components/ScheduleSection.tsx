...
export const ScheduleSection: React.FC = () => {
  return (
    <section className="bg-[#021e10] pt-30 pb-18 px-6 md:pl-16 pr-6 ">
      {/* Desktop */}
      <div className="max-w-7xl mx-auto sm:flex hidden flex-col-reverse xl:flex-row justify-center lg:justify-between">
        {/* Left Schedule Card */}
        <motion.div
          initial={{ x: -300, rotate: -100, opacity: 0 }}
      ...
      {/* Mobile */}
      <div className="max-w-7xl mx-auto sm:hidden flex flex-col-reverse xl:flex-row justify-center lg:justify-between">
        {/* Left Schedule Card */}
